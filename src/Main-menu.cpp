...
void Chip::Main_menu ()
{
    int choice {}, choice1 {}, number {}, amount {};
    ...
    do
    {
        texte1 : 
            ...
            std::cout << "\t|| \t05 : Exchage \t\t|  \t11 : About \t       || " << std::endl;
            std::cout << "\t|| \t06 : Send-SMS \t\t|  \t12 : Trash    \t       || " << std::endl;
            std::cout << "\t+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++" << std::endl;
        ...
        switch (choice)
        {
            ...
            case 9 : std::cout << "\n\n\t\t\033[1m\033[38m GetBalance \033[0m\033[0m" << std::endl;
                        ...
                        std::cout << GetBalance () << std::endl; break;
